...
Bullet::Bullet(int damage, Vector2f position, sf::Vector2f direction, int type) {

    this->damage = damage;
    string path = "data/img/survivor/bullet" + to_string(type) + ".png";
    sprite.load(path.c_str());
